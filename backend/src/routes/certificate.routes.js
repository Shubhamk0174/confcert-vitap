...
certificateRouter.post("/issue-certificate", isAuthenticated,isAdminOrClubAdmin, uploadSingleFile, issueCertificate);
...
certificateRouter.get("/getcertificate-user", isAuthenticated, getCertificatesofuser);
