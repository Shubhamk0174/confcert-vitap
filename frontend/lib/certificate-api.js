 ...
 */
export async function issueCertificate(certificateFile, studentName, email = '', sendEmail = false) {
  try {
 ...
 * @returns {Promise<{success: boolean, data?: object, error?: string}>}
 */
export async function bulkIssueCertificates(certificateFiles, studentNames, emails = [], sendEmail = false) {
  try {
    ...
    // Append student names and emails as JSON strings
